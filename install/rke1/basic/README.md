...
![Usage](https://github.com/markusewalker/Rancher-Goodies/blob/main/install/rke1/basic/usage.jpg)
...
In the `rke1/basic` folder, run the following commands:
...
Once done, navigate to the `rke1/basic/src` folder and perform one of the following commands:
...
![BATS Testing Result](https://github.com/markusewalker/Rancher-Goodies/blob/main/install/rke1/basic/bats.jpg)