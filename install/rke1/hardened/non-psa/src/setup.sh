...
Main() {
	echo -e "\x1B[96m======================================="
	echo -e "\tRKE1 Hardened Cluster Setup"
	echo -e "=======================================\x1B[0m\n"
    ...
    export SSH_PATH_NODE1="/net/$NODE1_PUBLIC/home/$USER/.ssh/id_rsa"
    export SSH_PATH_NODE2="/net/$NODE2_PUBLIC/home/$USER/.ssh/id_rsa"
    export SSH_PATH_NODE3="/net/$NODE3_PUBLIC/home/$USER/.ssh/id_rsa"
