...
resource "aws_lb" "aws_internal_nlb" {
  ...
  name               = "${var.aws_prefix}-internal-nlb"
}
...
resource "aws_lb_target_group" "aws_internal_tg_80" {
  ...
  protocol = "TCP"
  vpc_id   = var.aws_vpc
  name     = "${var.aws_prefix}-internal-tg-80"
  health_check {
    protocol            = "HTTP"
    port                = "traffic-port"
    path                = "/ping"
...
resource "aws_lb_target_group" "aws_internal_tg_443" {
  ...
  protocol = "TCP"
  vpc_id   = var.aws_vpc
  name     = "${var.aws_prefix}-internal-tg-443"
  health_check {
    protocol            = "HTTP"
    port                = 80
    path                = "/ping"
...
resource "aws_lb_target_group" "aws_internal_tg_6443" {
  ...
  protocol = "TCP"
  vpc_id   = var.aws_vpc
  name     = "${var.aws_prefix}-internal-tg-6443"
  health_check {
    protocol            = "HTTP"
    port                = 80
    path                = "/ping"
...
resource "aws_lb_target_group" "aws_internal_tg_9345" {
  ...
  protocol = "TCP"
  vpc_id   = var.aws_vpc
  name     = "${var.aws_prefix}-internal-tg-9345"
  health_check {
    protocol            = "HTTP"
    port                = 80
    path                = "/ping"
